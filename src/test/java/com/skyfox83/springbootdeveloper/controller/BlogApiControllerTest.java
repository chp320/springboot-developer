...
@SpringBootTest     // 스프링부트 테스트용 애플리케이션 컨텍스트
...
class BlogApiControllerTest {
    ...
    @Autowired
    protected ObjectMapper objectMapper;    // 직렬화, 역직렬화를 위한 클래스... 라는데 뭔말이여? ㅋㅋㅋ // java->json(직렬화), java<-json(역직렬화)
